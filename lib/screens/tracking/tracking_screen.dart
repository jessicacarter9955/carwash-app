              ...
              PolylineLayer(polylines: [
                if (tracking.routeCoords.isNotEmpty)
                  Polyline(
                    ...
                    color:
                        tracking.phase == TrackingPhase.toHub ? kMint : kCyan,
                    strokeWidth: 3,
                  ),
              ]),
              MarkerLayer(markers: [
                ...
                Marker(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Colors.white, width: 3),
                      boxShadow: [
                        BoxShadow(color: kCyan.withOpacity(0.4), blurRadius: 12)
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient:
                                const LinearGradient(colors: [kCyan, kMint]),
                            shape: BoxShape.circle,
                            boxShadow: [
                              BoxShadow(
                                  color: kCyan.withOpacity(0.3), blurRadius: 10)
                            ],
                          ),
                          child: const Text('🚗',
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            child: Text(tracking.driverPlate,
                                style: headStyle(
                                        size: 11,
...
class _OrderTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final steps = [
      ...
      {'id': 'pickup', 'label': 'Pickup', 'sub': 'Your location', 'icon': '📍'},
      {
        'id': 'washing',
        'label': 'Washing',
        'sub': 'At the facility',
            ...
            children: [
              Container(
                ...
                child: Center(
                    child: Text(icon,
                        style: TextStyle(
                            fontSize: 12, color: isDone ? kCyan3 : null))),
              ),
              if (!isLast)
                Expanded(
                    child: Container(
                        width: 2,
                        color: isDone ? kCyan.withOpacity(0.4) : kBorder2)),
            ],
          ),
